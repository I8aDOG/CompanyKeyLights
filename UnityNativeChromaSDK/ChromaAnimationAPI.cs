...
namespace ChromaSDK
{
    ...
    public class ChromaAnimationAPI
    {
        ...
        private static Dictionary<Key, int> _sKeyMapping = null;

        public static int GetKeyboardRazerKey(Key key)
        {
            if (_sKeyMapping == null)
            {
                _sKeyMapping = new Dictionary<Key, int>();
                _sKeyMapping[Key.Backspace] = (int)RazerKeyboard.RZKEY.RZKEY_BACKSPACE;
                _sKeyMapping[Key.Tab] = (int)RazerKeyboard.RZKEY.RZKEY_TAB;
                _sKeyMapping[Key.Enter] = (int)RazerKeyboard.RZKEY.RZKEY_ENTER;
                _sKeyMapping[Key.Pause] = (int)RazerKeyboard.RZKEY.RZKEY_PAUSE;
                _sKeyMapping[Key.Escape] = (int)RazerKeyboard.RZKEY.RZKEY_ESC;
                _sKeyMapping[Key.Space] = (int)RazerKeyboard.RZKEY.RZKEY_SPACE;
                _sKeyMapping[Key.Digit1] = (int)RazerKeyboard.RZKEY.RZKEY_1;
                _sKeyMapping[Key.Quote] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_8;
                _sKeyMapping[Key.Digit3] = (int)RazerKeyboard.RZKEY.RZKEY_3;
                _sKeyMapping[Key.Digit4] = (int)RazerKeyboard.RZKEY.RZKEY_4;
                _sKeyMapping[Key.Digit5] = (int)RazerKeyboard.RZKEY.RZKEY_7;
                _sKeyMapping[Key.Quote] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_8;
                _sKeyMapping[Key.Digit9] = (int)RazerKeyboard.RZKEY.RZKEY_9;
                _sKeyMapping[Key.Digit0] = (int)RazerKeyboard.RZKEY.RZKEY_0;
                _sKeyMapping[Key.Digit8] = (int)RazerKeyboard.RZKEY.RZKEY_8;
                _sKeyMapping[Key.Equals] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_3;
                _sKeyMapping[Key.Comma] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_9;
                _sKeyMapping[Key.Minus] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_2;
                _sKeyMapping[Key.Period] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_10;
                _sKeyMapping[Key.Slash] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_11;
                _sKeyMapping[Key.Digit0] = (int)RazerKeyboard.RZKEY.RZKEY_0;
                _sKeyMapping[Key.Digit1] = (int)RazerKeyboard.RZKEY.RZKEY_1;
                _sKeyMapping[Key.Digit2] = (int)RazerKeyboard.RZKEY.RZKEY_2;
                _sKeyMapping[Key.Digit3] = (int)RazerKeyboard.RZKEY.RZKEY_3;
                _sKeyMapping[Key.Digit4] = (int)RazerKeyboard.RZKEY.RZKEY_4;
                _sKeyMapping[Key.Digit5] = (int)RazerKeyboard.RZKEY.RZKEY_5;
                _sKeyMapping[Key.Digit6] = (int)RazerKeyboard.RZKEY.RZKEY_6;
                _sKeyMapping[Key.Digit7] = (int)RazerKeyboard.RZKEY.RZKEY_7;
                _sKeyMapping[Key.Digit8] = (int)RazerKeyboard.RZKEY.RZKEY_8;
                _sKeyMapping[Key.Digit9] = (int)RazerKeyboard.RZKEY.RZKEY_9;
                _sKeyMapping[Key.Semicolon] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_7;
                _sKeyMapping[Key.Semicolon] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_7;
                _sKeyMapping[Key.Comma] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_9;
                _sKeyMapping[Key.Equals] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_3;
                _sKeyMapping[Key.Period] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_10;
                _sKeyMapping[Key.Slash] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_11;
                _sKeyMapping[Key.Digit2] = (int)RazerKeyboard.RZKEY.RZKEY_2;
                _sKeyMapping[Key.LeftBracket] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_4;
                _sKeyMapping[Key.Backslash] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_6;
                _sKeyMapping[Key.RightBracket] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_5;
                _sKeyMapping[Key.Digit6] = (int)RazerKeyboard.RZKEY.RZKEY_6;
                _sKeyMapping[Key.Minus] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_2;
                _sKeyMapping[Key.Backquote] = (int)RazerKeyboard.RZKEY.RZKEY_OEM_1;
                _sKeyMapping[Key.A] = (int)RazerKeyboard.RZKEY.RZKEY_A;
                _sKeyMapping[Key.B] = (int)RazerKeyboard.RZKEY.RZKEY_B;
                _sKeyMapping[Key.C] = (int)RazerKeyboard.RZKEY.RZKEY_C;
                _sKeyMapping[Key.D] = (int)RazerKeyboard.RZKEY.RZKEY_D;
                _sKeyMapping[Key.E] = (int)RazerKeyboard.RZKEY.RZKEY_E;
                _sKeyMapping[Key.F] = (int)RazerKeyboard.RZKEY.RZKEY_F;
                _sKeyMapping[Key.G] = (int)RazerKeyboard.RZKEY.RZKEY_G;
                _sKeyMapping[Key.H] = (int)RazerKeyboard.RZKEY.RZKEY_H;
                _sKeyMapping[Key.I] = (int)RazerKeyboard.RZKEY.RZKEY_I;
                _sKeyMapping[Key.J] = (int)RazerKeyboard.RZKEY.RZKEY_J;
                _sKeyMapping[Key.K] = (int)RazerKeyboard.RZKEY.RZKEY_K;
                _sKeyMapping[Key.L] = (int)RazerKeyboard.RZKEY.RZKEY_L;
                _sKeyMapping[Key.M] = (int)RazerKeyboard.RZKEY.RZKEY_M;
                _sKeyMapping[Key.N] = (int)RazerKeyboard.RZKEY.RZKEY_N;
                _sKeyMapping[Key.O] = (int)RazerKeyboard.RZKEY.RZKEY_O;
                _sKeyMapping[Key.P] = (int)RazerKeyboard.RZKEY.RZKEY_P;
                _sKeyMapping[Key.Q] = (int)RazerKeyboard.RZKEY.RZKEY_Q;
                _sKeyMapping[Key.R] = (int)RazerKeyboard.RZKEY.RZKEY_R;
                _sKeyMapping[Key.S] = (int)RazerKeyboard.RZKEY.RZKEY_S;
                _sKeyMapping[Key.T] = (int)RazerKeyboard.RZKEY.RZKEY_T;
                _sKeyMapping[Key.U] = (int)RazerKeyboard.RZKEY.RZKEY_U;
                _sKeyMapping[Key.V] = (int)RazerKeyboard.RZKEY.RZKEY_V;
                _sKeyMapping[Key.W] = (int)RazerKeyboard.RZKEY.RZKEY_W;
                _sKeyMapping[Key.X] = (int)RazerKeyboard.RZKEY.RZKEY_X;
                _sKeyMapping[Key.Y] = (int)RazerKeyboard.RZKEY.RZKEY_Y;
                _sKeyMapping[Key.Z] = (int)RazerKeyboard.RZKEY.RZKEY_Z;
                _sKeyMapping[Key.Delete] = (int)RazerKeyboard.RZKEY.RZKEY_DELETE;
                _sKeyMapping[Key.Numpad0] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD0;
                _sKeyMapping[Key.Numpad1] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD1;
                _sKeyMapping[Key.Numpad2] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD2;
                _sKeyMapping[Key.Numpad3] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD3;
                _sKeyMapping[Key.Numpad4] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD4;
                _sKeyMapping[Key.Numpad5] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD5;
                _sKeyMapping[Key.Numpad6] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD6;
                _sKeyMapping[Key.Numpad7] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD7;
                _sKeyMapping[Key.Numpad8] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD8;
                _sKeyMapping[Key.Numpad9] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD9;
                _sKeyMapping[Key.NumpadPeriod] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD_DECIMAL;
                _sKeyMapping[Key.NumpadDivide] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD_DIVIDE;
                _sKeyMapping[Key.NumpadMultiply] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD_MULTIPLY;
                _sKeyMapping[Key.NumpadMinus] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD_SUBTRACT;
                _sKeyMapping[Key.NumpadPlus] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD_ADD;
                _sKeyMapping[Key.NumpadEnter] = (int)RazerKeyboard.RZKEY.RZKEY_NUMPAD_ENTER;
                _sKeyMapping[Key.UpArrow] = (int)RazerKeyboard.RZKEY.RZKEY_UP;
                _sKeyMapping[Key.DownArrow] = (int)RazerKeyboard.RZKEY.RZKEY_DOWN;
                _sKeyMapping[Key.RightArrow] = (int)RazerKeyboard.RZKEY.RZKEY_RIGHT;
                _sKeyMapping[Key.LeftArrow] = (int)RazerKeyboard.RZKEY.RZKEY_LEFT;
                _sKeyMapping[Key.Insert] = (int)RazerKeyboard.RZKEY.RZKEY_INSERT;
                _sKeyMapping[Key.Home] = (int)RazerKeyboard.RZKEY.RZKEY_HOME;
                _sKeyMapping[Key.End] = (int)RazerKeyboard.RZKEY.RZKEY_END;
                _sKeyMapping[Key.PageUp] = (int)RazerKeyboard.RZKEY.RZKEY_PAGEUP;
                _sKeyMapping[Key.PageDown] = (int)RazerKeyboard.RZKEY.RZKEY_PAGEDOWN;
                _sKeyMapping[Key.F1] = (int)RazerKeyboard.RZKEY.RZKEY_F1;
                _sKeyMapping[Key.F2] = (int)RazerKeyboard.RZKEY.RZKEY_F2;
                _sKeyMapping[Key.F3] = (int)RazerKeyboard.RZKEY.RZKEY_F3;
                _sKeyMapping[Key.F4] = (int)RazerKeyboard.RZKEY.RZKEY_F4;
                _sKeyMapping[Key.F5] = (int)RazerKeyboard.RZKEY.RZKEY_F5;
                _sKeyMapping[Key.F6] = (int)RazerKeyboard.RZKEY.RZKEY_F6;
                _sKeyMapping[Key.F7] = (int)RazerKeyboard.RZKEY.RZKEY_F7;
                _sKeyMapping[Key.F8] = (int)RazerKeyboard.RZKEY.RZKEY_F8;
                _sKeyMapping[Key.F9] = (int)RazerKeyboard.RZKEY.RZKEY_F9;
                _sKeyMapping[Key.F10] = (int)RazerKeyboard.RZKEY.RZKEY_F10;
                _sKeyMapping[Key.F11] = (int)RazerKeyboard.RZKEY.RZKEY_F11;
                _sKeyMapping[Key.F12] = (int)RazerKeyboard.RZKEY.RZKEY_F12;
                _sKeyMapping[Key.NumLock] = (int)RazerKeyboard.RZKEY.RZKEY_NUMLOCK;
                _sKeyMapping[Key.CapsLock] = (int)RazerKeyboard.RZKEY.RZKEY_CAPSLOCK;
                _sKeyMapping[Key.ScrollLock] = (int)RazerKeyboard.RZKEY.RZKEY_SCROLL;
                _sKeyMapping[Key.RightShift] = (int)RazerKeyboard.RZKEY.RZKEY_RSHIFT;
                _sKeyMapping[Key.LeftShift] = (int)RazerKeyboard.RZKEY.RZKEY_LSHIFT;
                _sKeyMapping[Key.RightCtrl] = (int)RazerKeyboard.RZKEY.RZKEY_RCTRL;
                _sKeyMapping[Key.LeftCtrl] = (int)RazerKeyboard.RZKEY.RZKEY_LCTRL;
                _sKeyMapping[Key.RightAlt] = (int)RazerKeyboard.RZKEY.RZKEY_RALT;
                _sKeyMapping[Key.LeftAlt] = (int)RazerKeyboard.RZKEY.RZKEY_LALT;
                _sKeyMapping[Key.LeftWindows] = (int)RazerKeyboard.RZKEY.RZKEY_LWIN;
                _sKeyMapping[Key.PrintScreen] = (int)RazerKeyboard.RZKEY.RZKEY_PRINTSCREEN;
                // _sKeyMapping[Key.SysReq] = (int)RazerKeyboard.RZKEY.RZKEY_PRINTSCREEN;
                _sKeyMapping[Key.Pause] = (int)RazerKeyboard.RZKEY.RZKEY_PAUSE;
                _sKeyMapping[Key.ContextMenu] = (int)RazerKeyboard.RZKEY.RZKEY_RMENU;
            }
            if (_sKeyMapping.ContainsKey(key))
            {
                return _sKeyMapping[key];
            }
            else
            {
                return (int)RazerKeyboard.RZKEY.RZKEY_INVALID;
            }
        }
